================================================================================
    BIBLIOTHÈQUE MICROSOFT FOUNDATION CLASS : Vue d'ensemble du projet DeathEditor
===============================================================================

L'Assistant Application a créé cette application DeathEditor pour  
...
Cette 
    icône est incluse par le fichier de ressource principal DeathEditor.rc.
...
DeathEditorView.h, DeathEditorView.cpp - la vue du document
    ...
    Les objets CDeathEditorView servent à afficher les objets CDeathEditorDoc.
...
(PCH) 
    nommé DeathEditor.pch et un fichier de type précompilé nommé 
Stdafx.obj.
